...
public class AssertionsTest {
    ...
    public void testSingleCheckbox(){
        ...
        driver.findElement(By.xpath("//*[@id=\"__next\"]/div/section/div/div/div[1]/label/input")).click();
        String actualMessage = driver.findElement(By.xpath("//p[text()='Checked!']")).getText();
